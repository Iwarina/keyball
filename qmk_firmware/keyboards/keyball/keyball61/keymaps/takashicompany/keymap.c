...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // Layer 5: Shifted version of Layer 0
    LAYOUT_universal(
        S(KC_ESC), S(KC_1),   S(KC_2),    S(KC_3),    S(KC_4),    S(KC_5),    S(KC_6),    S(KC_7),    S(KC_8),    S(KC_9),    S(KC_0),    S(KC_MINS),
        S(KC_DEL), S(KC_Q),   S(KC_W),    S(KC_E),    S(KC_R),    S(KC_T),    S(KC_Y),    S(KC_U),    S(KC_I),    S(KC_O),    S(KC_P),    S(KC_INT3),
        S(KC_TAB), S(KC_A),   S(KC_S),    S(KC_D),    S(KC_F),    S(KC_G),    S(KC_H),    S(KC_J),    S(KC_K),    S(KC_L),    S(KC_SCLN), S(KC_7),
        _______,   S(KC_Z),   S(KC_X),    S(KC_C),    S(KC_V),    S(KC_B),    S(KC_RBRC), S(KC_NUHS), S(KC_N),    S(KC_M),    S(KC_COMM), S(KC_DOT),  S(KC_SLSH), _______,
        _______,   _______,   _______,    _______,    _______,    _______,    _______,    S(KC_BSPC), _______,    _______,    _______,    _______,    _______,    S(KC_PSCR)
    )
};
#ifdef COMBO_ENABLE
